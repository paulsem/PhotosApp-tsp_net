    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            if (textBoxPath.Text.Length > 0)
            {
                ...
                if (PhotosApp.Class1.CheckPath(path) == false)
                {
                    List<string> aux = PhotosApp.Class1.GetDetails(path);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (open.ShowDialog() == DialogResult.OK)
            {
                ...
                if (PhotosApp.Class1.CheckPath(textBoxPath.Text) == false)
                {
                    List<string> aux = PhotosApp.Class1.GetDetails(textBoxPath.Text);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                PhotosApp.Class1.InsertNewImage(path, locatie, anotimp, data, persons);
            }
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            if (search.Length > 0)
            {
                List<string> aux = PhotosApp.Class1.GetPaths(search);
        ...
        private void updateDetalii_Click(object sender, EventArgs e)
        {
            ...
            if (PhotosApp.Class1.CheckPath(path) == false)
            {
                ...
                string persoana = Convert.ToString(PersoaneBox.Text);
                string[] persons = persoana.Split(' ');
                PhotosApp.Class1.UpdateDetails(path, locatie, anotimp, data, persons);
            }
        }
        ...
        {
            string path = textBox1.Text;
            PhotosApp.Class1.DeleteDetails(path);
